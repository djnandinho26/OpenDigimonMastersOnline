...
namespace ODMO.Commons.Packets.GameServer
{
    public class InitialInfoPacket : PacketWriter
    {
        ...
        public InitialInfoPacket(CharacterModel character, GameParty? party)
        {
            ...
            WriteInt(character.Partner.GeneralHandler); //nUID (n�o � mais utilizado?)
            ...
            WriteInt(0); //Id Boss vivo no mapa atual (j� � passado no ComplementarInfo)
            WriteByte(0); //PC Bang (???)
            ...
            WriteInt(0); //clientOption (aparenta ter rela��o com o tutorial)
            WriteInt(0); //Achievement rank

            WriteByte(0); //hatch atual j� rodou minigame
            ...
            WriteByte(0); //bloqueio de chat (se passar 1, informar a dura��o)
            //WriteInt(60);//Dura��o block chat em segundos 
            //Obs.: Passar 0 posteriormente n�o remove o valor da dura��o passado anteriormente.
